  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
        ...
        //  For example:
        //  ```
        //  sails_datastores__default__url: process.env.DATASTORE
        //  ```
        //--------------------------------------------------------------------------
      ...
      mysql: {
        adapter: 'sails-mysql',
        host: process.env.DB_HOST, // can user localhost or mysql connection either
        user: process.env.DB_USER, // your mysql username
        password: process.env.DB_PASSWORD, // your mysql password
        database: process.env.DB_SCHEMA // database name
      }
    ...
    ***************************************************************************/
    sockets: {
      ...
      ***************************************************************************/
      onlyAllowOrigins: [
        'http://localhost:1337', "http://34.209.64.150:1337"
      ],
